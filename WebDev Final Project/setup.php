...
try {
    ...
    $userTotal    = $db->countUsers();
    $bookingTotal = $db->countBookings();
    $counts = [
  ...
  <div class="card">
    ...
    <?php if ($ok): ?>
      ...
      <table>
        ...
        <tr><td>Users</td><td class="n"><?= (int)$counts['users'] ?></td></tr>
        <tr><td>Bookings</td><td class="n"><?= (int)$counts['bookings'] ?></td></tr>
      </table>
